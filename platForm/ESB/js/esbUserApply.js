layui.config({
    ...
    //esb应用列表数据
    var url = esbUrl + '/esbApply/getEsbApplyBypage';
    dataTable(url);
    ...
    function dataTable(url, where) {
        table.render({
            ...
            cols: [[
                ...
                // { field: 'esbApplyAppId', title: 'esbApplyAppId' },
                // { field: 'esbApplyId', title: 'esbApplyId' },
                { field: 'esbApplyDescription', title: '申请描述' },
                { field: 'esbAuditDescription', title: '审核描述' },
                { field: 'esbApplyStatus', title: '审核状态' },
                { field: 'esbApplyCreattime', title: '创建时间' },
