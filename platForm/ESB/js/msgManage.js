layui.config({
    ...
    $.ajax({
        type: "post",
        url: esbUrl + '/sysApplication/getAllActivemqMsgBypage',
        data: "data",
        dataType: "json",
    ...
    //             { title: '操作', width: 170, templet: '#msgManageListBar', fixed: "right", align: "center" }
    //         ]],
    //         done: function (res) {
    //             console.log(res)
    //         }
    ...
    //列表操作
    table.on('tool(msgManageList)', function (obj) {
